...
INSERT INTO `herramientas` VALUES (1,'Pinza p/crimbear','Intellinet','211048','7897984','14','sistemas','pinzas para clablear ethernet'),(2,'Pinza peladora','Steren','Her-620','861664','5','sistemas','pinzas para limpiar cable'),(3,'Terminal de impacto','Intellinet','211055','','12','sistemas',''),(4,'Multifunción cable','Intellinet','351898','','9','sistemas',''),(5,'Proskit','Eclipse','Part#500-021','','2','sistemas',''),(6,'Kit de programación','Development tools','MICROCHIP','MTI134900580','2','','x');
